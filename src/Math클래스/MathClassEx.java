...
public class MathClassEx {
    ...
    // random() 메서드 0.0 이상에서 1.0 미만의 범위에서 임의의 double 형 값 한개를 반환
    ...
    static void MathMethodFunc() {
        ...
        // floor() : 주어진 숫자를 내림한 결과를 반환
        System.out.println(Math.floor(10.999999999));  // 10
        // ceil() : 주어진 숫자를 올림한 결과를 반환
        System.out.println(Math.ceil(10.000000001));
        // round() : 소수점 첫째 자리에서 반올림 결과를 반환
        System.out.println(Math.round(10.499999999)); // 10, 소수점 첫째 자리를 반올림
        System.out.println(Math.round(10.599999999)); // 11
        // min()과 max()
